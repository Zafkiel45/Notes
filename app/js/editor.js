...
export function HandleElementContent() {
  try {
    ...
    Editables.forEach((editable) => {
      var _a;
      const elementString =
        (_a = editable.textContent) !== null && _a !== void 0 ? _a : "";
...
textarea.addEventListener("input", (event) => {
  var _a;
  content =
    (_a = String(event.target.textContent)) !== null && _a !== void 0 ? _a : "";
});
    ...
    return (
      ...
      ((_a =
        nodeList === null || nodeList === void 0
          ? void 0
          : nodeList.textContent) === null || _a === void 0
        ? void 0
        : _a.length)
    );
  }
...
export function handleCurrentSelectionElement() {
  const elementsWithContentEditable = document.querySelectorAll(
    "div[contenteditable]",
  );
